    ...
    <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
        ...
        <div class="col-md-6">
            <div class="skin-box-card">
                ...
                <div class="box-body">
                     ...
                     <div id="hidden_fields_one" class="hiddens">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                ...
                                <div id="environment_text_input " class="d-none">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" name="app_url" id="app_url" value="http://localhost" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
        ...
        <div class="col-md-6">
            <div class="skin-box-card">
                ...
                <div class="box-body">
                    <div id="hidden_fields_two" class="hiddens">
                    <div class="row">
                        <div class="col-md-6">
        ...
        <div class="box1 text-center">
           <h3 class="btn-custom">Additional Settings</h3>
        </div>
        ...
        <div class="box5">
            <div class="col-md-12"><br>
                <div class="skin-box-card">
                    <div class="box-header">
                        <h3 class="box-title">Aap Settings</h3>
                    </div>
                    <div class="box-body">
                        <div id="hidden_fields_three" class="hiddens">
                            <div class="row">
                                <div class="col-md-6">
